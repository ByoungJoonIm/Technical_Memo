...
- 첫 번째 장고 앱 작성(part3)[[원문](https://docs.djangoproject.com/ko/2.1/intro/tutorial03/)]
  ...
  - `vi polls/templates/polls/index.html`
    ...
    ```
- 첫 번째 장고 앱 작성(part4)[[원문](https://docs.djangoproject.com/ko/2.1/intro/tutorial04/)]
  - `vi polls/templates/polls/detail.html`
    ```
    # 모든 코드를 다음 코드로 바꾸기
  ...
  - `vi polls/templates/polls/results.html`
    ...
    ```
  - cf. race condition을 피하려면 : [링크](https://docs.djangoproject.com/ko/2.1/ref/models/expressions/#avoiding-race-conditions-using-f)
  - `vi polls/urls.py`
    ```
    # 전체를 다음과 같이 변경
    from django.urls import path
  ...
  - `vi polls/views.py`
    ```
    # index, detail, result를 다음과 같이 수정
